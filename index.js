...
function pegarValor() {
 investimentoInicial = parseFloat(document.querySelector("#valor-inicial").value)
 investimentoMensal = parseFloat(document.querySelector("#valor-mensal").value)
 ...
 if (taxaJuros > 0 && (investimentoInicial > 0|| investimentoMensal > 0)) {
   calcular(investimentoInicial, investimentoMensal, taxaJuros)
    ...
    for (var tempo = 0; acumulado < 1000000; tempo++) {
